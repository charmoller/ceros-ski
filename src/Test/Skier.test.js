...
test('Jump skier', () => {
    ...
    jumpSkier.move();
    expect(jumpSkier).toEqual({assetName: Constants.SKIER_DOWN, direction: Constants.SKIER_DIRECTIONS.DOWN, eaten: false, jump: 0, speed: Constants.SKIER_STARTING_SPEED, rhinoDelay: Constants.RHINO_DELAY - 100, x: 0, y: (100 * Constants.SKIER_STARTING_SPEED)});
});
