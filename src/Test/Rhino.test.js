...
test('Create new rhino object', () => {
    ...
    expect(rhino).toEqual({assetName: Constants.RHINO_DEFAULT, direction: Constants.SKIER_DIRECTIONS.DOWN, eating: false, eatingAnimate: Constants.RHINO_EAT.LIFT, previousDirection: Constants.SKIER_DIRECTIONS.DOWN, runningAsset: Constants.RHINO_RUN.RUN_1, runningAnimate: Constants.RHINO_RUNNING_ANIMATE, turning: 0, speed: Constants.RHINO_STARTING_SPEED, x: 0, y: 0});
});
